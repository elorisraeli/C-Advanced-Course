...
int *performOp(int *a, int *b, int size, /* FUNCTION POINTER PARAMETER */ int (*func_ptr)(int,int));
...
int main()
{
    ...
    while (choice != 5)
    {
        ...
        result = performOp(array1, array2, size, /* PASS IN FUNCTION POINTER FROM ARRAY[j] */ fpArr[j]);
